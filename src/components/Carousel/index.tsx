      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full">
        {booksOnPage.length > 0 ? (
          booksOnPage.map((book) => (
            <div
              key={book.id}
              className="bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col h-[380px] border border-green-100 hover:shadow-xl transition-shadow"
            >
              <div className="relative h-48 w-full">
                <Image
                  ...
                  onError={(e) => {
                    e.currentTarget.src =
                      "https://placehold.co/400x300/e2e8f0/64748b?text=Imagem+Indisponível";
                  }}
                />
              </div>
